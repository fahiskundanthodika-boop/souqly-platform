      ...
      <div className="p-6 max-w-3xl">
        ...
        {showForm && (
          <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => { setShowForm(false); setForm(empty); }} className="text-gray-400 hover:text-gray-600 text-xl">Ã—</button>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-500 uppercase mb-1">
                    {form.type === 'percent' ? 'Percentage (%)' : 'Amount (â‚¹)'} *
                  </label>
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-500 uppercase mb-1">Min Order Amount (â‚¹)</label>
                ...
                {form.type === 'percent' && (
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 uppercase mb-1">Max Discount Cap (â‚¹)</label>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
            <div className="text-5xl mb-3">ðŸŽŸï¸</div>
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {coupon.maxDiscount > 0 && ` Â· Max â‚¹${coupon.maxDiscount}`}
                    </div>
                    <div className="text-xs text-gray-400 mt-1">
                      Used {coupon.usedCount} times
                      {coupon.usageLimit > 0 && ` / ${coupon.usageLimit}`}
                      {coupon.expiresAt && ` Â· Expires ${new Date(coupon.expiresAt).toLocaleDateString('en-IN')}`}
                    </div>
                  </div>
